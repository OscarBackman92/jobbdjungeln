...
/** Only rendered when Google sign-in is actually configured. */
export function GoogleButton({ callbackURL = '/oversikt' }: { callbackURL?: string }) {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="size-4" aria-hidden focusable="false">
        ...
        <path
          fill="#EA4335"
          d="M12 4.8c1.8 0 3.3.6 4.5 1.8l3.4-3.4C17.9 1.2 15.2 0 12 0 7.4 0 3.4 2.6 1.4 6.5l4 3.1C6.3 6.8 8.9 4.8 12 4.8z"
        />
      </svg>
      Fortsätt med Google
    </Button>
